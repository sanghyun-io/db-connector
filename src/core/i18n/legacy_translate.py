...
_EN_TEXT_TRANSLATIONS = {
    ...
    "MySQL 병렬 Export 권한 설정": "Configure MySQL Parallel Export Privileges",
    "(백업 없음)": "(No backups)",
    "(미설정)": "(Not set)",
    "(복사)": "(Copy)",
    "가져오기": "Import",
    ...
    "다음": "Next",
    "닫기": "Close",
    "단일 연결로 계속": "Continue with One Connection",
    "대기 중": "Waiting",
    ...
    "권한 설정 안내": "Privilege Setup Guide",
    "소스 오류": "Source Error",
...
_EN_PHRASE_TRANSLATIONS = {
    ...
    "데이터": "Data",
    "대기 중": "Waiting",
    "단일 연결 일관 스냅샷으로 다시 시도 중...": "Retrying with a single-connection consistent snapshot...",
